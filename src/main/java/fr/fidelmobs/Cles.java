...
public final class Cles {
    ...
    public static final NamespacedKey INVOCATION_SPAWN_MS = new NamespacedKey("fidelmobs", "invocation_spawn_ms");
    ...
    public static final NamespacedKey FLECHE_MODELE_ID = new NamespacedKey("fidelmobs", "fleche_modele_id");
    ...
    public static final NamespacedKey POUVOIR_CHOIX_ID = new NamespacedKey("fidelmobs", "pouvoir_choix_id");
